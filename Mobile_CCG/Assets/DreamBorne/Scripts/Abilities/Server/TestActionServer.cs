...
public class TestActionServer : IActionServer
{
    ...
    {
        // Execute action
        Logger.LogAction($"This is a TestAction processed by the Server by {serverEngine.ServerData[playerId].Name}");
        
        // Prepare action parameters for client
        TestActionParams testActionParams = new TestActionParams($"This is a TestAction message invoked by {serverEngine.ServerData[playerId].Name}!");
